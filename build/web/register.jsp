<%-- 
    Document   : register
    Created on : Jul 25, 2024, 3:18:46 PM
    Author     : Nipuni
--%>
    ...
    <body>
        ...
        <div class="container col-sm-4 mt-4  ">
            ...
            <div class="bg-white rounded p-3">
                <h1 class="text-center" style="font-size:18pt;">Welcome To Register</h1>
                <%
                ...
                <form action="signup.jsp" method="post">
                    ...
                    <input type="text" name="name" id="" class="form-control mb-3" placeholder="" required>
                    <label for="">Enter your NIC/Passport</label>
                    <input type="text" name="nic" id="" class="form-control mb-3" placeholder="" required>
                    <label for="">Enter your Telephpne</label>
                    <input type="text" name="tel" id="" class="form-control mb-3" placeholder="" required>
                    ...
                    <a href="login.jsp" class="ms-3 ">Already Register? Login Here</a>
                </form>
            </div>
